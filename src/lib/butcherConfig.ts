...
export const CATEGORIES = {
  ...
  chicken: {
    ...
    items: [
      ...
      createUnavailableItem('c1i7', 'chicken lollipop', 'kg', defaultSize()),
      createUnavailableItem('c1i8', 'chicken parts', 'kg', defaultSize()),
      createUnavailableItem('c1i9', 'chicken nadan', 'kg', defaultSize()),
      createUnavailableItem('c1i10', 'chicken gizzard', 'kg', defaultSize()),
      createUnavailableItem('cli11', 'chicken soup bone', 'kg', defaultSize()),
      createUnavailableItem('c1i12', 'chicken thigh', 'kg', defaultSize()),
      createUnavailableItem('c1i13', 'chicken wings', 'kg', defaultSize()),
      createUnavailableItem('cli14', 'chicken drumstick', 'kg', defaultSize()),
      ...
      createUnavailableItem('c1i18', 'chicken quail', 'nos', defaultSize()),
    ]
  },
  ...
  beef: {
    ...
    items: [
      ...
      createUnavailableItem('b1i4', 'buffalo meat', 'kg', defaultSize()),
      createUnavailableItem('b1i5', 'buffalo boneless', 'kg', defaultSize()),
    ]
  },
