...
export const CATEGORIES = {
  ...
  steakFish: {
    ...
    items: [
      ...
      createUnavailableItem('i-ottimodha-meat', 'Otti Modha Meat - Otti Butter Fish Meat - ഓട്ടി മോദ മീറ്റ്', 'kg', defaultSize()),
...
const FISH_NAME_MAPPING: Record<string, string> = {
  ...
  'Otti Butter Fish Meat': 'Otti Modha Meat - Otti Butter Fish Meat - ഓട്ടി മോദ മീറ്റ്',
