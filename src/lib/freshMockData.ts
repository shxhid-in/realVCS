...
const createFishMenu = (): MenuCategory[] => [
  { id: 'cat-sea', name: 'Sea Water Fish', items: [
    ...
    createUnavailableItem('i-ayalakanni', 'Ayalakanni - Mackerel - അയലകണ്ണി', 'kg', fishSizes()),
    ...
    createUnavailableItem('i-velladavu', 'Velladavu - Sea', 'kg', fishSizes()),
    ...
    createUnavailableItem('i-ayalachembaan', 'Ayalachembaan - mackerelll - അയല ചെമ്പാൻ', 'kg', fishSizes()),
    createUnavailableItem('i-vellavatta', 'vella vatta- വെള്ള വറ്റ - white trevally', 'kg', fishSizes())
  ]},
