...
const createFishMenu = (): MenuCategory[] => [
  { id: 'cat-sea', name: 'Sea Water Fish', items: [
    ...
    { id: 'i-blackaavoli', name: 'Black Aavoli - Black Pomfret - ആവോলി', unit: 'kg', available: false, sizes: fishSizes() },
    ...
    { id: 'i-ayalakanni', name: 'Ayalakanni - Mackerel - അയലകണ്ണി', unit: 'kg', available: false, sizes: fishSizes() },
    ...
    { id: 'i-velladavu', name: 'Velladavu - Sea', unit: 'kg', available: false, sizes: fishSizes() },
  ...
  { id: 'cat-fresh', name: 'Fresh Water Fish', items: [
    ...
    { id: 'i-kadalkannan', name: 'Kadal Kannan - Kadal Kannan - കടൽ കണ്ണൻ', unit: 'kg', available: false, sizes: fishSizes() },
