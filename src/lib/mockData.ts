...
const createFishMenu = (): MenuCategory[] => JSON.parse(JSON.stringify([
  { id: 'cat-sea', name: 'Sea Water Fish', items: [
    ...
    { id: 'i-ayalakanni', name: 'Ayalakanni - Mackerel - അയലകണ്ണി', unit: 'kg', available: true, sizes: defaultSize() },
    ...
    { id: 'i-velladavu', name: 'Velladavu - Sea', unit: 'kg', available: true, sizes: defaultSize() },
  ...
  { id: 'cat-meat', name: 'Meat Items', items: [
    ...
    { id: 'i-ottimodha', name: 'Otti Modha - Ittu Butter Fish - ഓട്ടി മോദ', unit: 'kg', available: true, sizes: defaultSize() },
